  ...
  return (
    <div style={{maxWidth:'1100px', margin:'0 auto', padding:'150px 48px 100px', position:'relative', zIndex:1}}>
      ...
      <div style={{marginTop:'60px'}}>
        ...
        <div className="two-col-dash" style={{gridTemplateColumns:'repeat(auto-fit, minmax(280px,1fr))'}}>
          {mentor.testimonials.map((t,i)=>(
            <div className="quote" key={i}>
              <p>"{t.text}"</p>
              <div className="who"><span>{t.author}</span><span>{'★'.repeat(t.rating)}</span></div>
            </div>
          ))}
        </div>
      </div>
