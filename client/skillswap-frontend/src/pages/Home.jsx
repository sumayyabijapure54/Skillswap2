    ...
    <>
      <div className="hero">
        <div className="hero-left">
          ...
          <h1>Exchange Skills.<br /><span className="g">Grow Together.</span></h1>
      ...
      <section id="community">
        <div className="three-col">
          ...
          <div className="col-card">
            ...
            <div className="quote"><p>"SkillSwap helped me learn React in just 2 weeks! The community is amazing and so supportive."</p><div className="who"><span>Rohan Mehta</span><span>★★★★★</span></div></div>
            <div className="quote"><p>"I love teaching on SkillSwap. It feels great to share knowledge and learn new things in return."</p><div className="who"><span>Priya Sharma</span><span>★★★★★</span></div></div>
          </div>
          <div className="col-card">
