...
export default function Onboarding(){
  ...
  const next = async ()=>{
    ...
    setSubmitting(true);
    setError('');
    const res = await completeOnboarding({ role, interests, goal });
    setSubmitting(false);
  ...
  return (
    <div className="onboard-shell">
      ...
      <div className="onboard-actions">
        ...
        <button className="btn-primary-lg" onClick={next} disabled={!canNext || submitting} style={(!canNext || submitting)?{opacity:0.45, cursor:'not-allowed'}:{}}>
